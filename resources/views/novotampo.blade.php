...
<div class="row">
    ...
    <div class="col-md-6 mb-5">
        ...
        <h3>Inserir Novo Tampo</h3>

        <form action="/admin-tampos" method="post" enctype="multipart/form-data">
            @csrf
    ...
    <div class="col-lg-6">
        ...
        <table class="table table-striped text-center">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$t->nome}}</td>
                    <td><img width="100" class="img-fluid" src="img/tampos/{{$t->imagem}}" alt="{{$t->nome}}"></td>
                    <td>
                        <a class="btn btn-success edit-btn btn-width" href="#">Atualizar</a>
                        <form action="/novoproduto/tampos/{{$t->id}}" method="post">
                            @csrf
                            @method('DELETE')
